...
class ProcessedGraph:
    path: str = "D:/tokenizer_graph/mapped_new/"
...
class IterativeGraphRed:
    path: str = "D:/tokenizer_graph/mapped_new/graph_red_candidates/"

class IterativeMarginalGain:
    path: str = "D:/tokenizer_graph/mapped_new/margin_gain_candidates/"

class Baselines:
    path: str = "D:/tokenizer_graph/mapped_new/baselines_candidates/"


class Results:
    path: str = "D:/tokenizer_graph/mapped_new/results/"
